...
class ServoController:
    def __init__(self, servo_channel=0, min_angle=74, max_angle=140, servo_speed=2, direction=1):
...
if __name__ == "__main__":
    servo_controller = ServoController(servo_channel=0, min_angle=74, max_angle=140, servo_speed=2, direction=1)
