...
parser.add_argument("--model", type=str, default="yolo-v5", help="Choose the model or provide custom path")

args = parser.parse_args()

# Get argument first
nnBlobPath = str((Path(__file__).parent / Path('../models/yolov5/branch_openvino_2022.1_5shave.blob')).resolve().absolute())
if 1 < len(sys.argv):
    arg = sys.argv[1]
else:
    print("Using Tiny YoloV5 model. If you wish to use Tiny YOLOv3 or V4, use a different script")
